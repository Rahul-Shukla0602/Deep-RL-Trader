...
class Actor:
    def __init__(self, time_dim, state_dim, action_dim, hidden_dim):
        self.actor = ActorNet(state_dim * (time_dim + 1), hidden_dim, action_dim)
        self.target = ActorNet(state_dim * (time_dim + 1), hidden_dim, action_dim)
...
class Critic:
    def __init__(self, time_dim, state_dim, action_dim, hidden_dim):
        ...
        self.critic = CriticNet(state_dim * (time_dim + 1), hidden_dim, action_dim)
        self.target = CriticNet(state_dim * (time_dim + 1), hidden_dim, action_dim)
...
if __name__ == '__main__':
    critic = CriticNet(50 * (12 + 1), 37, 50)
